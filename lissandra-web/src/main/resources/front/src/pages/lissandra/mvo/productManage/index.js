...
class ProductManage extends PureComponent {
    ...
    onAddModalClicked() {
        this.props.dispatch({
            type: 'productManage/showAddModal'
        })
        if (this.form) {
    ...
    onAddModalCancel() {
        this.props.dispatch({
            type: 'productManage/hideAddModal'
        })
    }
    ...
    onUpdateModalClicked(record) {
        ...
        this.props.dispatch({
            type: 'productManage/showUpdateModal'
        })
    ...
    loadTableDataSource({
        ...
        this.props.dispatch({
            type: 'productManage/getTableList',
            payload: {
    ...
    componentDidMount() {
        ...
        this.props.dispatch({
            type: 'productManage/renderSearchModal'
        })
    }
}
